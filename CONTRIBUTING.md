...
Configuration: [test/vitest.integration.postgres.config.ts](test/vitest.integration.postgres.config.ts), [test/integration/postgres.proxy.config.json](test/integration/postgres.proxy.config.json)
