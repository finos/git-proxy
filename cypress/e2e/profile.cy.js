...
describe('Profile Page', () => {
  ...
  it('Displays user info: name, role, email, GitHub username, admin status', () => {
    cy.login('admin', 'admin');
  ...
  it("Non-admin viewing another user's profile cannot edit", () => {
