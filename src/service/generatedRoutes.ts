...
const models: TsoaRoute.Models = {
  ...
  RepoWithProxy: {
    ...
    properties: {
      ...
      users: {
        ...
        nestedProperties: {
          canAuthorise: { dataType: 'array', array: { dataType: 'string' }, required: true },
          canPush: { dataType: 'array', array: { dataType: 'string' }, required: true },
        },
        required: true,
      },
      _id: { dataType: 'string' },
  ...
  CommitData: {
    ...
    type: {
      ...
      nestedProperties: {
        message: { dataType: 'string', required: true },
        commitTimestamp: { dataType: 'string', required: true },
        committerEmail: { dataType: 'string', required: true },
        authorEmail: { dataType: 'string', required: true },
        committer: { dataType: 'string', required: true },
        author: { dataType: 'string', required: true },
        parent: { dataType: 'string', required: true },
        tree: { dataType: 'string', required: true },
      },
      validators: {},
    },
  },
      ...
      subSchemas: [
        { ref: 'AttestationBase' },
        {
          ...
          nestedProperties: {
            answers: {
              dataType: 'array',
              array: { dataType: 'refObject', ref: 'AttestationAnswer' },
              required: true,
            },
          },
        },
  ...
  Action: {
    ...
    properties: {
      ...
      commitData: {
        dataType: 'array',
        array: { dataType: 'refAlias', ref: 'CommitData' },
        default: [],
      },
    ...
    properties: {
      login: {
        ...
        nestedProperties: {
          ...
          action: { dataType: 'enum', enums: ['post'], required: true },
        },
        required: true,
      },
      profile: {
        ...
        nestedProperties: {
          uri: { dataType: 'string', required: true },
          action: { dataType: 'enum', enums: ['get'], required: true },
        },
        required: true,
      },
      logout: {
  ...
  LogoutResponse: {
    ...
    properties: {
      ...
      user: {
        dataType: 'union',
        subSchemas: [{ ref: 'Express.User' }, { dataType: 'undefined' }],
        required: true,
      },
    },
    additionalProperties: false,
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function UserController_getUser(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_getUser,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function RepoController_getRepos(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_getRepos,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function RepoController_getRepo(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_getRepo,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function RepoController_createRepo(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_createRepo,
          request,
          response,
        });
  ...
  app.patch(
    ...
    async function RepoController_addPushUser(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_addPushUser,
          request,
          response,
        });
  ...
  app.patch(
    '/api/v1/repo/:id/user/authorise',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(RepoController),
    ...fetchMiddlewares<RequestHandler>(RepoController.prototype.addAuthoriseUser),

    async function RepoController_addAuthoriseUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_addAuthoriseUser,
          request,
          response,
        });
  ...
  app.delete(
    '/api/v1/repo/:id/user/authorise/:username',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(RepoController),
    ...fetchMiddlewares<RequestHandler>(RepoController.prototype.removeAuthoriseUser),

    async function RepoController_removeAuthoriseUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_removeAuthoriseUser,
          request,
          response,
        });
  ...
  app.delete(
    '/api/v1/repo/:id/user/push/:username',
    authenticateMiddleware([{ jwt: [] }]),
    ...fetchMiddlewares<RequestHandler>(RepoController),
    ...
    async function RepoController_removePushUser(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_removePushUser,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function RepoController_deleteRepo(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRepoController_deleteRepo,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function PushController_getPushes(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPushController_getPushes,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function PushController_getPush(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPushController_getPush,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function PushController_rejectPush(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPushController_rejectPush,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function PushController_authorisePush(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPushController_authorisePush,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function PushController_cancelPush(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPushController_cancelPush,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function HomeController_getResources(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHomeController_getResources,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function HealthController_check(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHealthController_check,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ConfigController_getAttestation(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsConfigController_getAttestation,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ConfigController_getUrlShortener(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsConfigController_getUrlShortener,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ConfigController_getContactEmail(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsConfigController_getContactEmail,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ConfigController_getUiRouteAuth(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsConfigController_getUiRouteAuth,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AuthController_getResources(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_getResources,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AuthController_getAuthConfig(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_getAuthConfig,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AuthController_initiateOIDC(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_initiateOIDC,
          request,
          response,
        });
  ...
  app.get(
    '/api/auth/openidconnect/callback',
    ...fetchMiddlewares<RequestHandler>(AuthController),
    ...fetchMiddlewares<RequestHandler>(AuthController.prototype.handleOIDCCallback),

    async function AuthController_handleOIDCCallback(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_handleOIDCCallback,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AuthController_getProfile(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_getProfile,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function AuthController_updateGitAccount(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_updateGitAccount,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function AuthController_createUser(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_createUser,
          request,
          response,
        });
