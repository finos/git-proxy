...
Using the [cookie](/docs/get-started/authorize#2-authenticate-with-the-api) generated, execute a GET against the API to confirm that your push with `ID` exists in the database:
